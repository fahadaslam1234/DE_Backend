...
router.post("/create", upload, product.createProduct);
router.get("/getAllProducts", product.getAllProducts);
router.get("/getSingleProduct", product.getProductByID);
router.post("/delete", product.deleteProductByID);
router.post("/update", image_upload, product.updateProductByID);
